...
if (!empty($saveOrder))
{
	$saveOrderingUrl = 'index.php?option=com_staff&task=positions.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
	HTMLHelper::_('draggablelist.draggable');
}

?>

<form action="<?php echo Route::_('index.php?option=com_staff&view=positions'); ?>" method="post"
			...
			<?php echo LayoutHelper::render('joomla.searchtools.default', array('view' => $this)); ?>
				...
				<table class="table table-striped" id="positionList">
					...
					<th  scope="col" class="w-1 text-center">
						...
						<th class='left'>
							<?php echo HTMLHelper::_('searchtools.sort',  'COM_STAFF_POSITIONS_NAME', 'a.name', $listDirn, $listOrder); ?>
						</th>
					...
					<?php foreach ($this->items as $i => $item) :
						...
						<tr class="row<?php echo $i % 2; ?>" data-draggable-group='1' data-transition>
							...
							<td>
								...
								<?php endif; ?>
								<?php if ($canEdit) : ?>
									<a href="<?php echo Route::_('index.php?option=com_staff&task=position.edit&id='.(int) $item->id); ?>">
