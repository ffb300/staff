...
namespace Staff\Component\Staff\Administrator\View\Departments;
// No direct access
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_STAFF_TITLE_DEPARTMENTS'), "generic");
		...
		{
			$toolbar->preferences('com_staff');
		}

		// Set sidebar action
		Sidebar::setAction('index.php?option=com_staff&view=departments');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`name`' => Text::_('COM_STAFF_DEPARTMENTS_NAME'),
		);
	}
