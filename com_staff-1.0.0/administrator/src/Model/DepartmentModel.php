...
class DepartmentModel extends AdminModel
{
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_staff.department';
	 ...
	 * @since   1.0.0
	 */
	public function getTable($type = 'Department', $prefix = 'Administrator', $config = array())
	{
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_staff.edit.department.data', array());
	...
	/**
	 * Method to duplicate an Department
	 *
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__staff_department');
				$max             = $db->loadResult();
